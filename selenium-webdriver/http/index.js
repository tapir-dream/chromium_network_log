...
const COMMAND_MAP = new Map([
    ...
    // =========== Tapir ADD ===============
    [cmd.Name.SET_NETWORK_CONDITIONS, post('/session/:sessionId/chromium/network_conditions')],
    [cmd.Name.GET_NETWORK_CONDITIONS, get('/session/:sessionId/chromium/network_conditions')],
    [cmd.Name.DELETE_NETWORK_CONDITIONS, del('/session/:sessionId/chromium/network_conditions')],
]);
